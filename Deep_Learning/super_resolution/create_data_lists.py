...
with open(os.path.join(output_folder, 'train_images.csv'), 'w', newline='') as j:
    writer = csv.writer(j)
    for i in range(800):
...
with open(os.path.join(output_folder, 'valid_images.csv'), 'w', newline='') as j:
    writer = csv.writer(j)
    for i in range(100):
...
with open(os.path.join(output_folder, 'Set5_images.csv'), 'w', newline='') as j:
    writer = csv.writer(j)
    for i in range(num):
...
with open(os.path.join(output_folder, 'Set14_images.csv'), 'w', newline='') as j:
    writer = csv.writer(j)
    for i in range(num):
...
with open(os.path.join(output_folder, 'B100_images.csv'), 'w', newline='') as j:
    writer = csv.writer(j)
    for i in range(num):
...
with open(os.path.join(output_folder, 'Urban100_images.csv'), 'w', newline='') as j:
    writer = csv.writer(j)
    for i in range(num):
